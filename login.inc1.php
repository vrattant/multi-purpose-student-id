...
{
$query = mysqli_query($con,"SELECT * FROM student WHERE username ='".$username."' AND password1 ='".$password."'") or die(mysql_error()); 
...
<li><a href="index.html"><img src="images/home11.png" align = "right" height = 70 width = 70></a></li>
  ...
  <section id = "banner"><h1>Stuent Login Portal</h1></section>
</div>
